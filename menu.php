...
-->
  ...
  <a><span id="run" class="material-symbols-outlined" >directions_run</span>Trening</a>
...
<!---------------------------------------------------------------------------------------> 
  ...
  <a><span class="material-symbols-outlined">sentiment_satisfied</span>&nbsp;Humor</a> 
  ...
  <a><span class="material-symbols-outlined">music_note</span>Muzyka</a>
...
<li> 
  ...
  <a> <span class="material-symbols-outlined" style="transform:scale(1.2)">computer</span>Kursik</a>
 ...
 <li>
    ...
    <ol>
        <li><a href="astronomia.php">Astronomia</a></li>
        <li><a href="technologia">Technologia</a></li>
        <li><a href="ciekawostki">Ciekawostki</a></li>
    </ol>
  
  <a ><span class="material-symbols-outlined">rocket_launch</span>Nauka</a>
...
<li>
    ...
    <ol>
      ...
      <a><span class="material-symbols-outlined">folder</span> Portfolio</a>
    </li>
<!---------------------------------------------------------------------------------------> 
